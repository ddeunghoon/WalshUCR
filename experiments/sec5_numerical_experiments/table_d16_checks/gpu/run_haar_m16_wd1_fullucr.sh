...
export RUN_ROOT="${RUN_ROOT:-$PROJECT_DIR/experiments/sec5_numerical_experiments/table_d16_checks/results/memopt_haar_wd1_fullucr_nsys4_M16_instances00-09_r5_su61_steps1000_nomemopt}"
